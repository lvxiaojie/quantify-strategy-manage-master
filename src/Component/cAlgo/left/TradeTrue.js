...
var TodoList = React.createClass({
    ...
    beforeRender: function(strategyList,nianhua_data) {
    ...
    componentWillReceiveProps: function(getProp) {
        // setTimeout(()=>{
        this.beforeRender(getProp.StrategyList,getProp.nianhua_data);
        // },0)
    ...
    render: function() {
        ...
        return (
            ...
            <ul style={{overflow:'hidden',padding:0}}>
            {
                ...
                let astyle = {
                     color: x.status==-1?"#ff0000":"#ff6100",
                     cursor: "pointer",
                     marginLeft: '10px',
                     position: 'relative',
                 }
                    ...
                    return (
                        <li className={classN}  key={index} id={hisProfit_id}>
                            ...
                            data-toggle="collapse" data-target={"#" + menu_id}></i>
                              <a title={x.status==-1?x.error:"查看真实交易"} style={astyle} 
...
class TradeTrue extends Component {
    constructor(props) {
        super(props);
        this.state = {
            StrategyList: [],
    ...
    render() {
        ...
        return (
            <TodoList nianhua_data={this.props.nianhua_data} StrategyList={this.props.StrategyList}/>
        )
    }
}
...
export default connect(mapStateToProps)(TradeTrue);